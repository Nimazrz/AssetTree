...
class AssetRepository(
    ...
    private fun loadDisplaySettings(): DisplaySettings {
        ...
        val presetStr = prefs.getString("themePreset", AppThemePreset.NAVY_CLASSIC.name) ?: AppThemePreset.NAVY_CLASSIC.name
        val themePreset = try { AppThemePreset.valueOf(presetStr) } catch (e: Exception) { AppThemePreset.NAVY_CLASSIC }
    ...
    fun updateDisplaySettings(settings: DisplaySettings) {
        ...
        prefs.edit().apply {
            ...
            putString("themePreset", settings.themePreset.name)
